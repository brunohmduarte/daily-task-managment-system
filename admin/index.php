...
<head>
    ...
    <!-- plugins -->
    <link href="https://coderthemes.com/shreyu/assets/libs/flatpickr/flatpickr.min.css" rel="stylesheet" type="text/css" />
...
<body>
                ...
                <ul class="list-unstyled topnav-menu float-end mb-0">
                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="https://coderthemes.com/shreyu/assets/images/users/avatar-1.jpg" alt="user-image" class="rounded-circle">
        ...
        <div class="left-side-menu">
            <div class="h-100" data-simplebar>
                ...
                <div class="user-box text-center">
                    <img src="https://coderthemes.com/shreyu/assets/images/users/avatar-1.jpg" alt="user-img" title="Mat Helme" class="rounded-circle avatar-md">
                    <div class="dropdown">
                        <a href="javascript: void(0);" class="dropdown-toggle h5 mt-2 mb-1 d-block" data-bs-toggle="dropdown">Nik Patel</a>
    ...
    <!-- optional plugins -->
    <script src="https://coderthemes.com/shreyu/assets/libs/moment/min/moment.min.js"></script>
    <script src="https://coderthemes.com/shreyu/assets/libs/apexcharts/apexcharts.min.js"></script>
    <script src="https://coderthemes.com/shreyu/assets/libs/flatpickr/flatpickr.min.js"></script>

    <!-- page js -->
    <script src="https://coderthemes.com/shreyu/assets/js/pages/dashboard.init.js"></script>
