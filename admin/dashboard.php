<?php
    ...
    $controller = Factory::create(DashboardController::class);
    $controller->init();
?>
<!-- start page title -->
<div class="row">
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <h3 class="mb-0"><?= $controller->getTotalNumberOfTickets() ?></h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <h3 class="mb-0"><?= $controller->getTicketsResolved() ?></h3>
                    </div>
                    <div class="align-self-center flex-shrink-0">
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        ...
                        <h3 class="mb-0"><?= $controller->getTicketsClosed() ?></h3>
                    </div>
                    <div class="align-self-center flex-shrink-0">
