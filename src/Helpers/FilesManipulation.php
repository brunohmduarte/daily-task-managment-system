...
class FilesManipulation
{
    ...
    public function getListFilesDirectoryByExtension(string $directory = '', string $extension = '.txt'): array|false
    {
    ...
    public function isStoreInstalled(string $storeName): bool        
    {
